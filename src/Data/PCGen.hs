...
* genRange PCGen64: (-9223372036854775808,9223372036854775807)

NOTE: Types in this module provides Read and Show instances, but the exact
formatting used depends on if things were compiled in 32 or 64 bit mode. You
can't read back a string generated by the other version's show instance.
-}
module Data.PCGen (
    -- * 32 bits of output
    PCGen32(),
